...
export function posterLayout(spec, contentSvgWidth, contentSvgHeight, scale=1, portrait=true) {
    const layout = {
    ...
    cover.y = border.height + sheet.pad.t + sheet.pad.b
    sheet.height = border.height + sheet.pad.t + sheet.pad.b + cover.height
