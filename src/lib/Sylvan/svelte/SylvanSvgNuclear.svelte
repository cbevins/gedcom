<script>
    import SylvanSvgPerson from '$lib/Sylvan/svelte/SylvanSvgPerson.svelte'
...
<!-- Persons -->
<SylvanSvgPerson anode={anode.fatherAnode} geom={geom} subject='father' 
    x={x2} y={lineTop(1)} width={tagWidth} height={tagHeight} />

<SylvanSvgPerson anode={anode} geom={geom} subject='subject' 
    x={x2} y={lineTop(2)} width={tagWidth} height={tagHeight} />

<SylvanSvgPerson anode={anode.motherAnode} geom={geom} subject='mother' 
