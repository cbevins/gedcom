export class VinesGeom {
        ...
        this._data = {
            ...
            geom: {
                ...
                box: {
                    ...
                    middle: 10,     // padding between the father's and mother's tags
                    left: 40,       // padding between box left edge and tag left edge
                    right: 40,      // padding between tag right edge and box right edge
                ...
                tag: {
                    ...
                    width: 400,     // tag width in SVG viewBox units
                },
            },
    ...
    tagFatherTranslate() { return "translate(40, 20)" }
    tagHeight() { return this.tag().height }
    tagMotherTranslate() { return "translate(40, 50)" }
    ...
    linkChildData() { return "M 40, 30 L 20 30 L 20 60 L 40 60 M 20 45 L 0 45"}
    linkFatherData() { return "M 440, 30 L 460 30" }
    linkMotherData() { return "M 440 60 L 460 60" }

    linkPosParentX(pnode) { return this.boxPosX(pnode) }
    linkPosParentY(pnode) { return this.boxPosY(pnode) + this.boxHeight()/2 }
    linkPosChildX(pnode) { return this.boxPosX(pnode) - this.boxPadRight()/2 }
    linkPosChildY(pnode) {
