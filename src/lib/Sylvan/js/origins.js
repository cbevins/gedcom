 ...
 */
export function origins(subject) {
    const maternal = subject.mother() ? origins(subject.mother()) : new Map([[subject.birthCountry(),1]])
    const paternal = subject.father() ? origins(subject.father()) : new Map([[subject.birthCountry(),1]])
