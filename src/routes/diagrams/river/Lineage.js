/**
 * Class the creates a linked list of Lineage nodes
 * beginning with a root Person and traversing all ancestors
 * in father-descent-first traversal order.
 * 
 * It contains both
 * - an array of lineage nodes and
 * - a Map() of * {Person} => {node}
 * 
 * After construction, the user can further decorate each {node} as needed,
 * but the following properties are private:
 * - person: reference to the node's subject Person instance
